...
function CodeBlock({ className, children, node, ...rest }) {
  ...
  // so block vs. inline code is inferred the way react-markdown's own docs
  // recommend: a fenced block carries a `language-*` class, single-backtick
  // inline code does not. `node` is destructured out so the mdast/hast AST
  // object react-markdown attaches isn't spread onto the DOM element below.
